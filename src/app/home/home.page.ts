...
export class HomePage {
  ...
  ionViewDidEnter() {
    this.map = L.map('mapId').setView([-8.495752071349461 ,119.89006717092175], 12);
    ...
    const marker = L.circle([-8.495752071349461, 119.89006717092175], 500, {
      color: 'red',
      fillColor: 'red'
    });
    
    const popup = L.popup()
      .setContent('labuhan bajo merupakan...');
